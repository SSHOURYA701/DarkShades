...
class SignUpNGO extends Component {
  ...
  <div class="form-row">
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control" id="validationCustom03" placeholder="Enter Your Full Address" required />
      <div class="invalid-feedback">
  ...
  <br />
  <br/>
  {/* <button class="btn btn-danger " onClick={()=>this.props.onchagnehandler}>LogIn as a User</button> */}
        </>
